...
const Register = () => {
  return (
    <div className="relative h-full w-full bg-transparent flex items-center justify-center my-12">
      <div className="relative bg-white rounded-lg flex transition-all shadow-lg w-fit h-full items-center">
        ...
        <hr className="relative w-1 h-full bg-black" />
        <form className="relative p-7 w-fit h-auto bg-white rounded-lg flex flex-col gap-2 transition-all">
          ...
          <button
            type="submit"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-60 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Register
          </button>
        </form>
